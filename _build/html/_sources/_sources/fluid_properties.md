...
- **Density** ($\rho$): The mass per unit volume of a fluid, typically measured in $kg/m^3$.
...
The continuity equation expresses the conservation of mass in a fluid flow. For a steady flow of an incompressible fluid, the equation is:

$$ \nabla \cdot \mathbf{v} = 0 $$

or in integral form for a control volume:

$$ \int_{CS} \rho \mathbf{v} \cdot dA = 0 $$
...
Bernoulli’s principle relates the pressure, velocity, and elevation in a flowing fluid. For an incompressible and inviscid flow, it is expressed as:
